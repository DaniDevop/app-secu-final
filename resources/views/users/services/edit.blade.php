    ...
    <table id="schoolsTable">
        <thead>
            <tr>
                ...
                <th width="50%">Nom </th>
                <th width="15%">Date d ajoute</th>
                <th width="15%">Date de modification</th>
            ...
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="addSchoolModalLabel">
                        <i class="fas fa-university"></i> Modifier le  services
                    </h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <form id="schoolForm"  action="{{route('admin.service.editServicesPost')}}" method="POST">
                    @csrf
                    <div class="modal-body">
                        <div class="form-group">
                            ...
                            <input type="text" 
                                ...
                                value="{{$service->nom_services}}"
                                   required>
                            <div class="error-message" id="nameError">Le nom du service</div>
                        </div>

                        <!-- Champ caché pour l'ID (modification) -->
                        <input type="hidden"  value="{{$service->id}}" name="id" id="schoolId">
                    </div>
