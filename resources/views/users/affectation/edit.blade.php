...
<div class="d-flex justify-content-between mb-3">
    ...
    <button class="btn-add btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSchoolModal">
        <i class="fas fa-plus-circle me-2"></i>Modification de l affectation
    </button>
</div>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title"><i class="fas fa-plus-circle me-2"></i>Modification de l'Affectation</h5>
                <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"></button>
            </div>
            <form action="{{ route('users.EditAffectationAgent.editData') }}" method="POST">
                @csrf
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <select name="agent_stagiare_id" class="form-select" required>
                                <option value="{{ $affect->agent?->id }}">{{ $affect->agent?->name }} {{ $affect->agent?->prenom }} ({{ $affect->agent?->matricule }})</option>
                        ...
                        <div class="col-12">
                            ...
                            <select name="ecole_stage_id" class="form-select" required>
                                ...
                                <option value="{{ $affect->ecoles?->id }}"> {{ $affect->ecoles?->nom_ecole }}</option>
